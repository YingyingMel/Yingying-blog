      ...
      <div className='container'>
        ...
        <div className='rightside'>
          <div>
            ...
            <p style={{ fontSize: '15px' }}>So far, I have spent 5 months in studying front-end development.  The programming languages and skills I have learned are shown at your left-hand side. I built this blog for showing my projects, which includes a login/register system, 3 apps and a backend server. More projects will be added once I finish. If you have any suggestions for me, welcome to leave a message at the diary page. Thank you very much. </p>
          </div>
        </div>
      </div>
